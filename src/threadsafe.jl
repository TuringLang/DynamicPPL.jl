...
link!(vi::ThreadSafeVarInfo, spl::AbstractSampler, model) = link!(vi.varinfo, spl, model)
invlink!(vi::ThreadSafeVarInfo, spl::AbstractSampler, model) = invlink!(vi.varinfo, spl, model)
