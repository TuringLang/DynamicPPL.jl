...
There are three concrete strategies provided in DynamicPPL: [`InitFromPrior`](@ref), [`InitFromParams`](@ref), and [`InitFromUniform`](@ref).
See the [initialisation strategies page](@ref init-strategies) for more information.
